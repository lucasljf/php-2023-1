...
class CursoDao
{
    ...
    public function listar_tudo()
    {
        ...
        foreach ($resultados as $item) {
            ...
            $novo_curso = new Curso($item->id, $item->nome, $item->descricao, $item->carga_horaria, $item->data_inicio, $item->data_inicio);
    ...
    public function procurar_id($id)
    {
        ...
        $novo_curso = new Curso($resultado->id, $resultado->nome, $resultado->descricao, $resultado->carga_horaria, $resultado->data_inicio, $resultado->data_inicio);
